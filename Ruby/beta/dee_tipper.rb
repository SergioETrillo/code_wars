...
Dee is lazy but she's kind and she likes to eat out at all the nice restaurants
and gastropubs in town. To make paying quick and easy she uses a simple mental
algorithm she's called The Fair %20 Rule. She's gotten so good she can do this
in a few seconds and it always impresses her dates but she's perplexingly
...
Dee always politely smiles and says "Thank you" on her way out.
Dee is nice. Be like Dee.
...
def calc_tip(p, r)
  ...
  [0, t].max   # an elegant way to return 0 if t is negative without ifs
end
